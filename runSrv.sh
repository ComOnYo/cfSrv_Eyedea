...
#./server1/crazyflie-clients-python/bin/cfzmq & ./server2/crazyflie-clients-python/bin/cfzmq & ./server3/crazyflie-clients-python/bin/cfzmq & ./server4/crazyflie-clients-python/bin/cfzmq
